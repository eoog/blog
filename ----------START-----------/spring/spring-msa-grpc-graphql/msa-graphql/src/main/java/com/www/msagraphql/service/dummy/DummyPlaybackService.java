...
public class DummyPlaybackService {
  ...
  private void initData() {
    ...
    PlaybackRecord record1 = new PlaybackRecord(recordCounter.incrementAndGet(), 1L, 101L,
        "2024-01-01T10:00:00Z", "2024-01-01T11:00:00Z");
    PlaybackRecord record2 = new PlaybackRecord(recordCounter.incrementAndGet(), 2L, 102L,
        "2024-01-02T10:00:00Z", "2024-01-02T11:00:00Z");
    records.add(record1);
    records.add(record2);

    // Adding some dummy event logs
    eventLogs.add(new EventLog(eventCounter.incrementAndGet(), record1.getRecordId(), 1L, "play",
        "2024-01-01T10:00:00Z"));
    eventLogs.add(new EventLog(eventCounter.incrementAndGet(), record1.getRecordId(), 1L, "pause",
        "2024-01-01T10:30:00Z"));
    eventLogs.add(new EventLog(eventCounter.incrementAndGet(), record2.getRecordId(), 2L, "play",
  ...
  public PlaybackRecord endRecord(Long recordId) {
    PlaybackRecord endRecord = records.stream()
