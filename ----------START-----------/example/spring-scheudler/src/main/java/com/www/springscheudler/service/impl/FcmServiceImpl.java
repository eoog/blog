package com.www.springscheudler.service.impl;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.google.auth.oauth2.GoogleCredentials;
import com.www.springscheudler.mapper.FcmMapper;
import com.www.springscheudler.model.FcmMessageDto;
import com.www.springscheudler.model.FcmSendDeviceDto;
import com.www.springscheudler.model.FcmSendDto;
import com.www.springscheudler.service.FcmService;
...
public class FcmServiceImpl implements FcmService {
    ...
    public void sendMessageTo(FcmSendDto fcmSendDto) throws IOException {
        ...
        String API_URL = "https://fcm.googleapis.com/v1/projects/meercat-ch-admin/messages:send";
    ...
    private String getAccessToken() throws IOException {
        String firebaseConfigPath = "firebase/meercat-ch-admin-firebase-adminsdk-o724j-0b2351f853.json";
