package com.www.springscheudler.model.common;
...
public enum ErrorCode {
    ...
    // 서버가 처리 할 방법을 모르는 경우 발생
    NOT_VALID_CODE(500, "G999", "Not a valid EmailVrfcType"),
    ...
    BUSINESS_EXCEPTION_ERROR(200, "9999", "Business Exception Error"),
    ...
    // 생성자 구성
    ErrorCode(final int status, final String resultCode, final String resultMsg) {
        this.status = status;
