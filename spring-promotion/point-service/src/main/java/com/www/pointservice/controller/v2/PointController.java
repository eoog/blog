package com.www.pointservice.controller.v2;
...
import com.www.pointservice.service.v2.PointRedisService;
...
public class PointController {
  ...
  private final com.www.pointservice.controller.v1.PointController pointControllerV1;

  @PostMapping("/earn")
  public ResponseEntity<Response> earnPoints(@Valid @RequestBody PointDto.EarnRequest request) {
  ...
  public ResponseEntity<PointDto.Response> cancelPoints(
      ...
      @Valid @RequestBody PointDto.CancelReqeust request) {
  ...
  public ResponseEntity<Page<Response>> getPointHistory(
