package com.www.couponservice.service.v3;
...
import com.www.couponservice.service.v2.CouponStateService;
...
public class CouponService {
  ...
  public void issueCoupon(CouponDto.IssueMessage message) {
    try {
      ...
      log.info("Coupon issued successfully: policyId={}, userId={}", message.getPolicyId(),
          message.getUserId());
  ...
  public Coupon cancelCoupon(Long couponId) {
    Coupon coupon = couponRepository.findByIdAndUserId(couponId,
            UserIdInterceptor.getCurrentUserId())
