package com.www.msacoursechatservice.domain;


import com.www.msacoursechatservice.domain.Chat.ChatMessage;
...
public class ChatService extends ChatServiceGrpc.ChatServiceImplBase {
  ...
  public ChatService(RedisTemplate<String, String> redisTemplate,
      StringRedisTemplate stringRedisTemplate, RedisMessageListenerContainer redisContainer) {
  ...
  @Override
  public void sendMessage(Chat.SendMessageRequest request,
      StreamObserver<Chat.SendMessageResponse> responseObserver) {
    ...
    try {
      ...
      stringRedisTemplate.convertAndSend(channel,
          message.getUserId() + "::" + message.getContent() + "::" + message.getMessageId() + "::"
  ...
  @Override
  public void subscribeMessages(Chat.SubscribeMessagesRequest request,
      StreamObserver<Chat.ChatMessage> responseObserver) {
  ...
  @Override
  public void getMessages(Chat.GetMessagesRequest request,
      StreamObserver<Chat.GetMessagesResponse> responseObserver) {
