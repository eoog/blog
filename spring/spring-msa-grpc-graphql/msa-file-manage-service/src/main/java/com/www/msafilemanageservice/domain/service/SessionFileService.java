...
public class SessionFileService {
  ...
  public Optional<SessionFile> findTopBySessionIdOrderByFileIdDesc(Long sessionId) {
    Optional<SessionFile> result = sessionFileRepository.findTopBySessionIdOrderByFileIdDesc(sessionId);
    return result;
  }
  ...
  // 파일 삭제하기
  public void deleteFile(Long fileId) {sessionFileRepository.deleteById(fileId);}
}
