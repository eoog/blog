...
-- 강의 평가(COURSE_RATINGS) 테이블에 초기 데이터 삽입 이거 안됌..
...
VALUES (100, 100, 100, 5, '훌륭한 강의입니다!', '2023-01-03 12:00:00'),
       (200, 100, 100, 4, '아주 좋았지만 조금 어려웠어요', '2023-01-04 12:00:00'),
       (300, 200, 200, 5, '초보자에게 최고의 강의', '2023-01-05 12:00:00'),
       (400, 200, 300, 3, '내용은 좋지만 구성이 조금 아쉽네요', '2023-01-06 12:00:00');
